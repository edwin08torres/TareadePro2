...
public class FrmVehicle extends javax.swing.JFrame {
    ...
    private pnlViewController pnlvc ;
    ...
    public static LinkedList <Vehicle>vh = new LinkedList<Vehicle>();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(542, 548));
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
      pnlView lista = new pnlView();
      lista.setVisible(true);
      lista.cargarInterfaz();
      
      Vehicle v;
        
            for (int i = 0; i < vh.size(); i++) {
               v = (Vehicle)vh.get(i);
               lista.MostrarDatos(v);
        }
