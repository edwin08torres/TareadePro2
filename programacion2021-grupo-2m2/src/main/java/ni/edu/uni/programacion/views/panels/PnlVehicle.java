...
public class PnlVehicle extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        fmtVin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fmtVinActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
            int opc = JOptionPane.showConfirmDialog(null, "Estas seguro que quieres cerrar la app??",
    ...
    private void fmtVinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fmtVinActionPerformed
       if(fmtVin.getText().isEmpty()){
             JOptionPane.showMessageDialog(null, "ERROR, debe llenar los campos de textos");
       }
    }//GEN-LAST:event_fmtVinActionPerformed
